...
// $('#buissnes').on('submit',function() {
//     return $('#buissnes').jqxValidator('validate');
// })
// $('#buissnes-2').on('submit',function() {
//     return $('#buissnes-2').jqxValidator('validate');
// })
// $('#notified').on('submit',function() {
//     return $('#notified').jqxValidator('validate');
// })
// $('#contact').on('submit',function() {
//     return $('#contact').jqxValidator('validate');
// })
// $('#blockstack-id-mobile').on('submit',function() {
//     return $('#blockstack-id').jqxValidator('validate');
// })
  ...
  function submitId() {
        ...
        if (inputVal.includes(".id" || ".id.blockstack" || ".dmail.id")) {
            alert('Thank you for submitting your id, we will notify you later!')
        } else {
            alert("Please write a better id format")
        }
    }
